...
class GoogleImageLoader:
    ...
    def searchImageURLs(self):
        ...
        #     print(google_api.format(keyword, i * 8))
        ...
        resO = {
            "responseData": [
                ...
                {
                    "url": "http://pic11.nipic.com/20101125/5852238_122910962059_2.jpg"
                },
                {
                    "url": "http://img.taopic.com/uploads/allimg/140127/234786-14012G14A654.jpg"
                },
                {
                    "url": "http://news.xinhuanet.com/food/2014-02/11/126108534_13920092517081n.jpg"
                },
                {
                    "url": "http://img1.cache.netease.com/catchpic/1/12/128FAAC244BCC8CE19F050FE2ADE6AA7.jpg"
                },
                {
                    "url": "http://www.foodqs.cn/news/imgtest/s006/201201101053026721.jpg"
                },
                {
                    "url": "http://pfscnew.agri.gov.cn/ncpflzs/201106/W020110608564590362799.jpg"
                }
            ]
        }
        ...
        page_urls = [result["url"] for result in page_data["responseData"]]
        image_urls.extend(page_urls)
